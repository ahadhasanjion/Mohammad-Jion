        ...
        <section className='pb-24  pt-24'>
            <div id="contact" className="w-full md:w-full sm:w-full space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto text-center mt-14 mb-14">
                ...
                <form  action="https://formspree.io/f/mzbwnygj" method='POST' className="px-14">
                    ...
                    <button className='resume-link inline-block bg-purple-400 rounded-full bg-gradient-to-r p-[2px] text-white focus:outline-none focus:ring active:text-opacity-75'> <span class="block rounded-full  px-8 py-3 text-sm font-medium hover:bg-transparent">
                        SEND
                    </span></button>
